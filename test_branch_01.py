...
def test_function_print_All_Divisors():
    # тест 1
    n = 10
    n_out = print_All_Divisors(n) # [1,2,5,10]
    if n_out == [1,2,5,10]:
        print('Test 1 is OK')
    else:
        print('Test 1 is failed')
    # тест 2
    n = 40
    n_out = print_All_Divisors(n) #[1, 2, 4, 5, 8, 10, 20, 40]
    ...
    # тест 3
    n = -10
    n_out = print_All_Divisors(n) #'Функция принимает на вход целые числа'
    if n_out == 'Функция принимает на вход целые числа':
        print('Test 3 is OK')
    else:
        print('Test 3 is failed')
    ...
    # тест 6
    n = '273801'
    n_out = print_All_Divisors(n)  # [1, 3, 11, 33, 8297, 24891, 91267, 273801]
...
def test_function_the_Biggest_Prime_Divisor():
    # тест 1
    n = 10
    n_out = the_Biggest_Prime_Divisor(n)
    if n_out == 5:
        print('Test 1 is OK')
    else:
        print('Test 1 is failed')
    # тест 2
    n = 777
    n_out = the_Biggest_Prime_Divisor(n) #37
    if n_out == 37:
        print('Test 2 is OK')
    else:
        print('Test 2 is failed')
...
def test_function_the_Biggest_Devisor():
    # тест 1
    n = 1000
    n_out = the_Biggest_Devisor(n) #500
    if n_out == 500:
        print('Test 1 is OK')
    else:
        print('Test 1 is failed')
    # тест 2
    n = 273801
    n_out = the_Biggest_Devisor(n)  # 91267
    if n_out == 91267:
        print('Test 2 is OK')
    else:
        print('Test 2 is failed')
...
def test_function_prime_Multipliers_Canonical():
    # тест 1
    n = 273801
    n_out = prime_Multipliers_Canonical(n)
